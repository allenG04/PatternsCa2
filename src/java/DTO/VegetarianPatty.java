 ...
 * @author allen
 */
public class VegetarianPatty extends BurgerDecorator {
    
    public VegetarianPatty(Burger newBurger)
    {
        super(newBurger);
    }
    ...
    public String getOrigBeef(){
        return basicBurger.getOrigBeef() + ", Vegetarian special filling";
    }
    ...
    public String getDescription(){
        return basicBurger.getDescription() + ", Vegetarian Meat";
    }
